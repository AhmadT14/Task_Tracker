...
if (fs.existsSync(filePath)) {
    ...
    try {
        ...
        newTask = {id:null, description:description, status:'todo', createdAt:new Date().toISOString(), updatedAt:null}
...
newTask = {id:1, description:description, status:'todo', createdAt:new Date().toISOString(), updatedAt:null}
